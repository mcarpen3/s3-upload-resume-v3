...
let maximumUploadSize = 5 * 1024 * 1024 * 1024; // 5GB
let commonUploadSize1 = 10 * 1024 * 1024;     // 10MB
let commonUploadSize2 = 15 * 1024 * 1024;   // 15MB
let commonUploadSize3 = 20 * 1024 * 1024;   // 20MB
let minimumUploadSize = 5 * 1024 * 1024;    // 5MB
